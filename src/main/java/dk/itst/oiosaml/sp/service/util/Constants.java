...
public interface Constants {
	...
	// 添加对接业务系统的属性，在oiosaml-sp.properties中配置 v1.0
	static final String PROP_LOGIN_RESPONSE = "oiosaml-sp.uri.login.response";
	...
	static final String PROP_LOGIN_RESPONSE_WITH_PARAM = "oiosaml-sp.uri.login.response.withparam";
